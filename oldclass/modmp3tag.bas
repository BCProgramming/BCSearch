...
Public Function MP3read_GetTagInfo_ID3v2(ByVal mp3FileName$, ByRef songTitle$, ByRef songArtist$, ByRef songAlbum$, ByRef songYear As Long, ByRef songComment$, ByRef songTrackNumber As Long, ByRef songGenre As String, ByRef songComposer$, ByRef songOriginalArtist$, ByRef songCopyright$, ByRef songURL$, ByRef songEncodedBy$) As Boolean
