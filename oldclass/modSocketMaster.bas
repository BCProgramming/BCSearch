...
Public Function HiWordA(lngValue As Long) As Long
If (lngValue And &H80000000) = &H80000000 Then
    HiWordA = ((lngValue And &H7FFF0000) \ &H10000) Or &H8000&
Else
    HiWordA = (lngValue And &HFFFF0000) \ &H10000
End If
End Function

'Returns the low word from a double word.
Public Function LoWordA(lngValue As Long) As Long
LoWordA = (lngValue And &HFFFF&)
End Function

'Receives a string pointer and it turns it into a regular string.
Public Function StringFromPointerA(ByVal lPointer As Long) As String
Dim strTemp As String
Dim lRetVal As Long

strTemp = String$(api_lstrlen(ByVal lPointer), 0)
lRetVal = api_lstrcpy(ByVal strTemp, ByVal lPointer)
If lRetVal Then StringFromPointerA = strTemp
End Function
